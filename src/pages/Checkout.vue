<template lang="">
  <div class="w-full">
    <div class="flex">
      ...
      <div class="w-1/2 px-6 space-y-8">
            <h2 class="mt-20 mb-10 text-3xl font-semibold tracking-wider">Order summary</h2>
        ...
        <div class="flex gap-2">
          ...
          <button class="px-4 py-2 text-white bg-[#DB4444] rounded">Apply Coupon</button>
        </div>
        <button class="rounded px-4 py-2 text-white bg-[#DB4444]">Place Order</button>
      </div>
    </div>
  </div>
</template>
